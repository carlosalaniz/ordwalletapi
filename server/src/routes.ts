...
const models: TsoaRoute.Models = {
    ...
    "CardinalBalance": {
        "dataType": "refObject",
        "properties": {
            "cardinal": {"dataType":"double","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "BTCTransactions": {
        "dataType": "refObject",
        "properties": {
            "transaction": {"dataType":"string","required":true},
            "confirmations": {"dataType":"enum","enums":[4],"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/wallet/status',
            ...
            function WalletController_status(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/wallet/create',
            ...
            function WalletController_create(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/wallet/restore',
            ...
            function WalletController_restore(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.restore.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/wallet/inscribe',
            ...
            try {
              ...
              const promise = controller.inscribe.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
